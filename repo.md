...
![量化误差 vs 位宽](error_vs_bitwidth.png)

* 从这里我们可以看到，位宽越低，所有方法的量化误差普遍较低，并且zp方法的效果要普遍比abs方法的效果好，沿着输出通道量化的结果要好于输入通道
...
![lm_head 量化敏感度](lmhead_sensitivity.png)

* 上图可以看出在输出通道和输入通道相反的层lm_head，沿着输出通道进行量化的效果明显更好
